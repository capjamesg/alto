...
def generate_auth_token(
    ...
    **kwargs
    ...
    :param code_challenge: The code challenge used to generate an auth token.
    :type code_challenge: str
    :param expiry_seconds: The number of seconds until the token expires (default: 3600).
    :type expiry_seconds: str
    ...
    return AuthTokenResponse(code=encoded_code, code_challenge=code_challenge, exp=expiry_seconds, iat=iat)
